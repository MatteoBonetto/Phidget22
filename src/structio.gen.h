...
PhidgetReturnCode readLEDArrayColor(BridgePacket *bp, PhidgetLEDArray_ColorHandle dst);
PhidgetReturnCode writeLEDArrayColor(const PhidgetLEDArray_ColorHandle src, BridgePacket *bp);
PhidgetReturnCode readAnimation(BridgePacket *bp, PhidgetLEDArray_AnimationHandle dst);
PhidgetReturnCode writeAnimation(const PhidgetLEDArray_AnimationHandle src, BridgePacket *bp);
