...
PhidgetRCServo_getMaxVelocityLimit(PhidgetRCServoHandle ch, double *maxVelocityLimit) {
	...
	if (ch->maxVelocityLimit == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
...
PhidgetRCServo_getMaxAcceleration(PhidgetRCServoHandle ch, double *maxAcceleration) {
	...
	if (ch->maxAcceleration == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
...
PhidgetRCServo_getMinAcceleration(PhidgetRCServoHandle ch, double *minAcceleration) {
	...
	if (ch->minAcceleration == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
...
PhidgetRCServo_getPosition(PhidgetRCServoHandle ch, double *position) {
	...
	if (ch->position == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
		*position = PUNK_DBL;
		return (PHID_RETURN(EPHIDGET_UNKNOWNVAL));
	}
...
PhidgetRCServo_setTargetPosition(PhidgetRCServoHandle ch, double targetPosition) {
	...
	if (ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL)
		return (PHID_RETURN_ERRSTR(EPHIDGET_NOTCONFIGURED, "The MinPulseWidth and MaxPulseWidth must be set before setting the TargetPosition."));
...
PhidgetRCServo_getTargetPosition(PhidgetRCServoHandle ch, double *targetPosition) {
	...
	if (ch->targetPosition == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
...
PhidgetRCServo_setVelocityLimit(PhidgetRCServoHandle ch, double velocityLimit) {
	...
	if (ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL)
		return (PHID_RETURN_ERRSTR(EPHIDGET_NOTCONFIGURED, "The MinPulseWidth and MaxPulseWidth must be set before setting the VelocityLimit."));
...
PhidgetRCServo_getVelocityLimit(PhidgetRCServoHandle ch, double *velocityLimit) {
	...
	if (ch->velocityLimit == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
...
PhidgetRCServo_getVelocity(PhidgetRCServoHandle ch, double *velocity) {
	...
	if (ch->velocity == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
		*velocity = PUNK_DBL;
		return (PHID_RETURN(EPHIDGET_UNKNOWNVAL));
	}
...
PhidgetRCServo_setAcceleration(PhidgetRCServoHandle ch, double acceleration) {
	...
	if (ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL)
		return (PHID_RETURN_ERRSTR(EPHIDGET_NOTCONFIGURED, "The MinPulseWidth and MaxPulseWidth must be set before setting the Acceleration."));
...
PhidgetRCServo_getAcceleration(PhidgetRCServoHandle ch, double *acceleration) {
	...
	if (ch->acceleration == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
...
PhidgetRCServo_getMinVelocityLimit(PhidgetRCServoHandle ch, double *minVelocityLimit) {
	...
	if (ch->minVelocityLimit == PUNK_DBL || ch->minPulseWidth == PUNK_DBL || ch->maxPulseWidth == PUNK_DBL) {
