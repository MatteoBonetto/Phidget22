...
struct _PhidgetMotorPositionController {
	...
	PhidgetMotorPositionController_OnExpectedPositionChangeCallback ExpectedPositionChange;
	void *ExpectedPositionChangeCtx;
...
_initAfterOpen(PhidgetChannelHandle phid) {
	...
	case PHIDCHUID_DCC1020_MOTORPOSITIONCONTROLLER_100:
		...
		ch->targetPosition = PUNK_INT64;
		ch->position = PUNK_INT64;
		ch->enableExpectedPosition = PUNK_BOOL;
