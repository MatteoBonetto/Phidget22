...
API_PRETURN
PhidgetMotorVelocityController_setAcceleration(PhidgetMotorVelocityControllerHandle ch, double acceleration) {
	...
	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETACCELERATION, NULL, NULL, 1, "%g", acceleration / fabs(ch->rescaleFactor)));
}

API_PRETURN
PhidgetMotorVelocityController_getAcceleration(PhidgetMotorVelocityControllerHandle ch, double *acceleration) {
...
API_PRETURN
PhidgetMotorVelocityController_getMinAcceleration(PhidgetMotorVelocityControllerHandle ch, double *minAcceleration) {
...
API_PRETURN
PhidgetMotorVelocityController_getMaxAcceleration(PhidgetMotorVelocityControllerHandle ch, double *maxAcceleration) {
...
API_PRETURN
PhidgetMotorVelocityController_getMaxTargetVelocity(PhidgetMotorVelocityControllerHandle ch, double *maxTargetVelocity) {
...
API_PRETURN
PhidgetMotorVelocityController_setRescaleFactor(PhidgetMotorVelocityControllerHandle ch, double rescaleFactor) {
...
API_PRETURN
PhidgetMotorVelocityController_getMinTargetVelocity(PhidgetMotorVelocityControllerHandle ch, double *minTargetVelocity) {
...
PhidgetMotorVelocityController_setTargetVelocity(PhidgetMotorVelocityControllerHandle ch, double TargetVelocity) {
	...
	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETDUTYCYCLE, NULL, NULL, 1, "%g", TargetVelocity / (ch->rescaleFactor)));
}
...
PhidgetMotorVelocityController_setDeadBand(PhidgetMotorVelocityControllerHandle ch, double deadBand) {
	...
	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETDEADBAND, NULL, NULL, 1, "%g", ((deadBand / fabs(ch->rescaleFactor)))));
}
...
API_PRETURN
PhidgetMotorVelocityController_setStallVelocity(PhidgetMotorVelocityControllerHandle ch, double stallVelocity) {
	...
	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETSTALLVELOCITY, NULL, NULL, 1, "%g", stallVelocity / fabs(ch->rescaleFactor)));
}
...
API_PRETURN
PhidgetMotorVelocityController_setKp(PhidgetMotorVelocityControllerHandle ch, double Kp) {
...
API_PRETURN
PhidgetMotorVelocityController_getKp(PhidgetMotorVelocityControllerHandle ch, double *Kp) {
...
API_PRETURN
PhidgetMotorVelocityController_setKi(PhidgetMotorVelocityControllerHandle ch, double Ki) {

	TESTPTR_PR(ch);
	TESTCHANNELCLASS_PR(ch, PHIDCHCLASS_MOTORVELOCITYCONTROLLER);
	TESTATTACHED_PR(ch);

	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETKI, NULL, NULL, 1, "%g", Ki * fabs(ch->rescaleFactor)));
}

API_PRETURN
PhidgetMotorVelocityController_getKi(PhidgetMotorVelocityControllerHandle ch, double *Ki) {
...
API_PRETURN
PhidgetMotorVelocityController_setKd(PhidgetMotorVelocityControllerHandle ch, double Kd) {

	TESTPTR_PR(ch);
	TESTCHANNELCLASS_PR(ch, PHIDCHCLASS_MOTORVELOCITYCONTROLLER);
	TESTATTACHED_PR(ch);

	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETKD, NULL, NULL, 1, "%g", Kd * fabs(ch->rescaleFactor)));
}

API_PRETURN
PhidgetMotorVelocityController_getKd(PhidgetMotorVelocityControllerHandle ch, double *Kd) {
...
API_PRETURN
PhidgetMotorVelocityController_setPositionType(PhidgetMotorVelocityControllerHandle ch, Phidget_PositionType positionType) {
	PhidgetReturnCode ret;
	...
	ret = (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_POSITIONTYPE, NULL, NULL, 1, "%d", positionType));
...
API_PRETURN
PhidgetMotorVelocityController_getPositionType(PhidgetMotorVelocityControllerHandle ch, Phidget_PositionType *positionType) {
