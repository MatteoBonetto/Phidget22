...
bridgepacketinfo_t bridgepacketinfo[] = {
	...
	{ "BP_RCSERVOVOLTAGECHANGE", 0}, /* 0xd1 */
	{ "BP_LEDFORWARDVOLTAGECHANGE", 0}, /* 0xd2 */
	{ "BP_SETCHANNELPERSISTENCE", 0}, /* 0xd3 */
	{ "BP_READNFCFULL", BP_FLAG_NOFORWARD}, /* 0xd4 */
	{ "BP_READNFCNDEF", BP_FLAG_NOFORWARD}, /* 0xd5 */
	{ (void *)0, 0 }
};
